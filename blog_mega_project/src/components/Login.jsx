...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full py-12 px-4 sm:px-6 lg:px-8">
      <div
        className={`mx-auto w-full max-w-lg bg-gray-700 rounded-xl p-10 border border-black/10`}
      >
          ...
          <div className="space-y-5">
            <Input
              ...
              {...register("email", {
                ...
                validate: {
                  matchPattern: (value) =>
                    /^(?:\w+([.-]?\w+)*@(?:gmail\.com|yahoo\.com))$/.test(
                      value 
                    ) || "Email address must be a valid Gmail or Yahoo address",
                },
              })}
            />
            <Input
